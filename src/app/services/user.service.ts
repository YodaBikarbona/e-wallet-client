...
export class UserService {
  ...
  editProfile(user: any) {
    const request = new EditProfile(user.firstName, user.lastName, user.birthDate, user.country_id, user.city_id, user.address, user.email, user.phone, user.gender, user.currency_id, user.edited);
